export function SunIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M16.286 22C19.442 22 22 19.472 22 16.353c0-2.472-1.607-4.573-3.845-5.338C17.837 8.194 15.415 6 12.476 6 9.32 6 6.762 8.528 6.762 11.647c0 .69.125 1.35.354 1.962a4.351 4.351 0 0 0-.83-.08C3.919 13.53 2 15.426 2 17.765 2 20.104 3.919 22 6.286 22z"
        fill="currentColor"
      />
    </svg>
  )

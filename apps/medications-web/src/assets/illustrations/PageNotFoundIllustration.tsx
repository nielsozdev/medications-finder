...
function PageNotFoundIllustration({ ...other }: BoxProps) {
  ...
  return (
    ...
    >
      ...
      <image height="300" href="/assets/illustrations/characters/character_6.png" x="205" y="30" />
      ...
      <path d="M111.1 120c30.8-.5 30.8-46.3 0-46.8-30.8.5-30.8 46.3 0 46.8z" fill="#FFD666" />
      <path
